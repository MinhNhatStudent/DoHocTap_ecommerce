...
CREATE TABLE `yeuthich` (
  ...
  CONSTRAINT `yeuthich_ibfk_1` FOREIGN KEY (`UserID`) REFERENCES `nguoidung` (`UserID`),
  CONSTRAINT `yeuthich_ibfk_2` FOREIGN KEY (`ProductID`) REFERENCES `sanpham` (`ProductID`)
